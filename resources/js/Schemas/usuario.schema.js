...
export const usuarioSchema = z
    .object({
        ...
        usu_rut: z
            .string()
            .min(7, { message: 'El RUT es obligatorio' })
        ...
        usu_analisis: z.string().max(50, { message: 'Máximo 50 caracteres' }).nullable().optional(),
        usu_gerencia: z.string().max(150, { message: 'Máximo 150 caracteres' }).nullable().optional(),
