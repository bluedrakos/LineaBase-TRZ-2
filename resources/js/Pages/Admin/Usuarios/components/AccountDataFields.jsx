...
export default function AccountDataFields({ register, errors, setValue, watch, roles = [] }) {
    ...
    return (
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div>
                ...
                {errors.usu_tipo && (
                    <p className="text-sm text-red-500">{errors.usu_tipo.message}</p>
                )}
            </div>
            ...
            {tipo === 'Interno' && (
                <div>
                    ...
                    />
                    {errors.usu_ldap && (
                        <p className="text-sm text-red-500">{errors.usu_ldap.message}</p>
                    )}
                </div>
            )}
