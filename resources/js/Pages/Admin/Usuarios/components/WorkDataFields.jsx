...
export default function WorkDataFields({ register, errors, setValue, watch, instituciones = [] }) {
    return (
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div>
                ...
                {errors.usu_cargo && (
                    <p className="text-sm text-red-500">{errors.usu_cargo.message}</p>
                )}
            </div>
            ...
            <div>
                ...
                {errors.usu_gerencia && (
                    <p className="text-sm text-[#b91c1c]">{errors.usu_gerencia.message}</p>
                )}
            </div>
            ...
            <div>
                ...
                <Input id="usu_analisis" {...register('usu_analisis')} placeholder="Número de análisis" />
                {errors.usu_analisis && (
                    <p className="text-sm text-[#b91c1c]">{errors.usu_analisis.message}</p>
                )}
            </div>
                ...
                >
                    ...
                    <SelectContent>
                        ...
                        {instituciones.map((ins) => (
                            <SelectItem key={ins.ins_id} value={ins.ins_id.toString()}>
                                {ins.ins_nombre}
                            </SelectItem>
                        ))}
                    </SelectContent>
