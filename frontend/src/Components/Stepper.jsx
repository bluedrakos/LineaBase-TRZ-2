...
export default function Stepper({
    ...
    return (
        <div className="flex w-full flex-col p-0" {...rest}>
            <div
                    ...
                    <div className={`px-8 pb-8 ${footerClassName}`}>
                        ...
                        >
                            ...
                            <button
                                ...
                                className="flex items-center justify-center rounded-md bg-[#004064] px-3.5 py-1.5 font-medium tracking-tight text-white transition duration-350 hover:bg-green-600 active:bg-green-700"
                                {...nextButtonProps}
                            >
