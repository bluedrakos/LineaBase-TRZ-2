        ...
        <Tabs defaultValue="general" className="w-full">
            ...
            <TabsContent value="general" className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        <div className="flex items-start gap-3">
                            <User2 className="text-muted-foreground mt-1 h-5 w-5" />
                            <div>
                                <Label className="text-muted-foreground block text-xs font-semibold">
                                    Nombre Completo
                                </Label>
                                <div className="mt-1 text-sm font-medium">
                                    {usuario.usu_nombre} {usuario.usu_apellidos}
                                </div>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            <Fingerprint className="text-muted-foreground mt-1 h-5 w-5" />
                            <div>
                                <Label className="text-muted-foreground block text-xs font-semibold">
                                    RUT
                                </Label>
                                <div className="mt-1 text-sm font-medium">
                                    {formatearRut(usuario.usu_rut)}
                                </div>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-sm font-medium">
                                    {formatearTelefono(usuario.usu_telefono)}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        <div className="flex items-start gap-3">
                            <Briefcase className="text-muted-foreground mt-1 h-5 w-5" />
                            <div>
                                <Label className="text-muted-foreground block text-xs font-semibold">
                                    Cargo
                                </Label>
                                <div className="mt-1 text-sm font-medium">
                                    {usuario.usu_cargo || 'N/A'}
                                </div>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            <Building className="text-muted-foreground mt-1 h-5 w-5" />
                            <div>
                                <Label className="text-muted-foreground block text-xs font-semibold">
                                    Gerencia
                                </Label>
                                <div className="mt-1 text-sm font-medium">
                                    {usuario.usu_gerencia || 'N/A'}
                                </div>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-sm font-medium">
                                    {usuario.usu_seccion || 'N/A'}
                                </div>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            <Activity className="text-muted-foreground mt-1 h-5 w-5" />
                            <div>
                                <Label className="text-muted-foreground block text-xs font-semibold">
                                    Análisis
                                </Label>
                                <div className="mt-1 text-sm font-medium">
                                    {usuario.usu_analisis || 'N/A'}
                                </div>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-sm font-medium">
                                    {usuario.institucion?.ins_nombre || 'N/A'}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        {usuario.usu_tipo === 'Interno' && (
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="mt-1 text-sm font-medium">
                                        {usuario.usu_ldap || 'N/A'}
                                    </div>
                                </div>
                            </div>
                        )}
                        <div className="flex items-start gap-3">
                            <ShieldCheck className="text-muted-foreground mt-1 h-5 w-5" />
                            <div>
                                <Label className="text-muted-foreground block text-xs font-semibold">
                                    Rol
                                </Label>
                                <div className="mt-1 text-sm font-medium">
                                    {usuario.rol?.rol_nombre || 'N/A'}
                                </div>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
